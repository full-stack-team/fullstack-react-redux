#full stack developement using react and redux - build microservice

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone https://github.com/full-stack-team/fullstack-react-redux.git`
3. **Make sure you're in the directory you just created.** - `cd fullstack-react-redux`
...
8. Use path.resolve on all path references in both the dev and prod webpack.config. [See this commit]
path.resolve(__dirname, 'src/index') for an example.
9. Delete any .eslintrc that you're storing in your user directory
